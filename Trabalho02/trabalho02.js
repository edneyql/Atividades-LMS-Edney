...
function showMessages(group){
    ...
    xhttp.open('GET','http://rest.learncode.academy/api/Edney/'+id, true);
    xhttp.send();
};
...
function sendMessage(group, message){
    ...
    xhttp.open('POST', 'http://rest.learncode.academy/api/Edney/'+id, true);
...
xhttp.open('GET','http://rest.learncode.academy/api/Edney/groups', true);
xhttp.send();
...
function postGroup(name, id){
    ...
    xhttp.open('POST', 'http://rest.learncode.academy/api/Edney/groups', true);
    xhttp.setRequestHeader("Content-Type", "application/json");
