...
function exibirItemFinalizarCompra(item){
    let template = [
        '<div class="row" id="item'+item.id+'">',
            '<div class="col-md-2"><img style="width:80px; height:80px" class="img-responsive" src="midias/'+item.image+'"></div>',
            '<div class="col-md-4">',
...
$.get("http://rest.learncode.academy/api/Edney/comprasLoja/", function(response){
...
$("#finalizar").click(function(){
    ...
    $.ajax({
        url: "http://rest.learncode.academy/api/Edney/comprasLoja/",
        type: "POST",
        data: carrinho,
